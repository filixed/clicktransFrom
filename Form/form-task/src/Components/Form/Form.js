...
const FormTask = () => {
    ...
    const [valBrutto, setValBrutto] = useState(0.0)
    ...
    const onSubmit = (data) =>{
     ...
     useEffect(() => {
         setValBrutto(watchFields[0]*watchFields[1])
         setValue("priceBrutto", valBrutto.toFixed(2))
     }, [watch, watchFields, setValue, valBrutto])
    ...
    return(
            ...
            {errorOccured && <p>Something went wrong</p>}
            </div>
